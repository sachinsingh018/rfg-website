                ...
                <div className="flex gap-2">
                  {images.map((_, i) => (
                    <button
                      ...
                      className={`h-2 rounded-full transition-all ${i === imageIndex ? 'w-8 bg-primary' : 'w-2 bg-muted-foreground/30'
                        }`}
            ...
            <div className="relative z-10">
              ...
              <div className="grid lg:grid-cols-2 gap-4 md:gap-8 lg:gap-12">
                ...
                <div className="relative rounded-xl overflow-hidden shadow-lg border border-border/50 h-[350px] md:h-[400px] lg:h-full min-h-[350px]">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3771.1234567890123!2d72.863679!3d19.120569!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTnCsDA3JzE0LjAiTiA3MsKwNTEnNDkuMiJF!5e0!3m2!1sen!2sin!4v1234567890123!5m2!1sen!2sin"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    title="Rhomboid Finguru Location"
                  />
                  {/* Link to open in Google Maps - positioned to not interfere with marker */}
                  <a
                    href="https://maps.app.goo.gl/gdYLwCas5cAzaayD7"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="absolute bottom-4 right-4 z-30 bg-white px-4 py-2 rounded-lg shadow-lg text-sm font-semibold text-primary hover:bg-primary hover:text-white transition-colors"
